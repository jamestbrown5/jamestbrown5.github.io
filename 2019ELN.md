...
excerpt: Lab notes from research projects conducted in 2019. I focused on searching
  literature, analyzing data, and preparing for my graduate program exit interview all while being a USDA Pathways student intern.
output:
  html_document:
    df_print: paged
author_profile: yes
